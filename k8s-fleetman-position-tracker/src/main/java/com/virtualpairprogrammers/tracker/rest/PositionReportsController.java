...
public class PositionReportsController 
{
	...
	public Collection<VehiclePosition> getUpdatedPositions(@RequestParam(value="since", required=false) @DateTimeFormat(pattern="yyyy-MM-dd'T'HH:mm:ss.SSSZ") Date since)
	{
